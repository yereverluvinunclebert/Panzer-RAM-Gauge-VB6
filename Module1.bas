...
Public Function fLicenceState() As Integer
    ...
    If fFExists(PzGSettingsFile) Then ' does the tool's own settings.ini exist?
        slicence = fGetINISetting("Software\PzRAMGauge", "licence", PzGSettingsFile)
...
Public Sub readPrefsPosition()
   ...
   On Error GoTo readPrefsPosition_Error
    ...
    If PzGDpiAwareness = "1" Then
        PzGFormHighDpiXPosTwips = fGetINISetting("Software\PzRAMGauge", "formHighDpiXPosTwips", PzGSettingsFile)
        PzGFormHighDpiYPosTwips = fGetINISetting("Software\PzRAMGauge", "formHighDpiYPosTwips", PzGSettingsFile)
...
'        End If
    Else
        PzGFormLowDpiXPosTwips = fGetINISetting("Software\PzRAMGauge", "formLowDpiXPosTwips", PzGSettingsFile)
        PzGFormLowDpiYPosTwips = fGetINISetting("Software\PzRAMGauge", "formLowDpiYPosTwips", PzGSettingsFile)
   ...
   On Error GoTo writePrefsPosition_Error
    ...
    If panzerPrefs.WindowState = vbNormal Then ' when vbMinimised the value = -48000  !
        If PzGDpiAwareness = "1" Then
            ...
            sPutINISetting "Software\PzRAMGauge", "formHighDpiXPosTwips", PzGFormHighDpiXPosTwips, PzGSettingsFile
            sPutINISetting "Software\PzRAMGauge", "formHighDpiYPosTwips", PzGFormHighDpiYPosTwips, PzGSettingsFile
        Else
            PzGFormLowDpiXPosTwips = Str$(panzerPrefs.Left)
            PzGFormLowDpiYPosTwips = Str$(panzerPrefs.Top)
            
            ' now write those params to the toolSettings.ini
            sPutINISetting "Software\PzRAMGauge", "formLowDpiXPosTwips", PzGFormLowDpiXPosTwips, PzGSettingsFile
            sPutINISetting "Software\PzRAMGauge", "formLowDpiYPosTwips", PzGFormLowDpiYPosTwips, PzGSettingsFile
