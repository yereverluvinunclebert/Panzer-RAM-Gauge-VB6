...
Private Sub chkEnablePrefsTooltips_Click()
   ...
   On Error GoTo chkEnablePrefsTooltips_Click_Error
    ...
    If prefsStartupFlg = False Then
        ...
        sPutINISetting "Software\PzRAMGauge", "enablePrefsTooltips", gblEnablePrefsTooltips, gblSettingsFile
...
'    End If
    ...
    If gblStartup = "1" Then
        Call savestring(HKEY_CURRENT_USER, "SOFTWARE\Microsoft\Windows\CurrentVersion\Run", "PzRAMGaugeWidget", """" & App.path & "\" & "Panzer RAM Gauge.exe""")
    Else
        Call savestring(HKEY_CURRENT_USER, "SOFTWARE\Microsoft\Windows\CurrentVersion\Run", "PzRAMGaugeWidget", vbNullString)
    End If

    ' save the values from the general tab
    If fFExists(gblSettingsFile) Then
        sPutINISetting "Software\PzRAMGauge", "enableTooltips", gblEnableTooltips, gblSettingsFile
        sPutINISetting "Software\PzRAMGauge", "enablePrefsTooltips", gblEnablePrefsTooltips, gblSettingsFile
        sPutINISetting "Software\PzRAMGauge", "enableBalloonTooltips", gblEnableBalloonTooltips, gblSettingsFile
        ...
        sPutINISetting "Software\PzRAMGauge", "gaugeFunctions", gblGaugeFunctions, gblSettingsFile
        ...
        'sPutINISetting "Software\PzRAMGauge", "clockFaceSwitchPref", gblClockFaceSwitchPref, gblSettingsFile
'        sPutINISetting "Software\PzRAMGauge", "mainGaugeTimeZone", gblMainGaugeTimeZone, gblSettingsFile
'        sPutINISetting "Software\PzRAMGauge", "mainDaylightSaving", gblMainDaylightSaving, gblSettingsFile
        'sPutINISetting "Software\PzRAMGauge", "secondaryGaugeTimeZone", gblSecondaryGaugeTimeZone, gblSettingsFile
        'sPutINISetting "Software\PzRAMGauge", "secondaryDaylightSaving", gblSecondaryDaylightSaving, gblSettingsFile
        ...
        sPutINISetting "Software\PzRAMGauge", "clockFont", gblClockFont, gblSettingsFile
        ...
        sPutINISetting "Software\PzRAMGauge", "defaultEditor", gblDefaultEditor, gblSettingsFile
        
        sPutINISetting "Software\PzRAMGauge", "clockHighDpiXPos", gblClockHighDpiXPos, gblSettingsFile
        sPutINISetting "Software\PzRAMGauge", "clockHighDpiYPos", gblClockHighDpiYPos, gblSettingsFile
        
        sPutINISetting "Software\PzRAMGauge", "clockLowDpiXPos", gblClockLowDpiXPos, gblSettingsFile
        sPutINISetting "Software\PzRAMGauge", "clockLowDpiYPos", gblClockLowDpiYPos, gblSettingsFile
...
'        cmbMainDaylightSaving.ToolTipText = "Select and activate Daylight Savings Time for your area."
        ...
        cmbTickSwitchPref.ToolTipText = "The movement of the hand can be set to smooth or regular flicks, the smooth movement uses slightly more RAM."
