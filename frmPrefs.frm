...
Private Sub chkDpiAwareness_Click()
    ...
    If prefsStartupFlg = False Then ' don't run this on startup
        ...
        sPutINISetting "Software\PzRAMGauge", "dpiAwareness", PzGDpiAwareness, PzGSettingsFile
...
Private Sub chkEnablePrefsTooltips_Click()
   ...
   On Error GoTo chkEnablePrefsTooltips_Click_Error
    ...
    If prefsStartupFlg = False Then
        ...
        sPutINISetting "Software\PzRAMGauge", "enablePrefsTooltips", PzGEnablePrefsTooltips, PzGSettingsFile
...
Private Sub chkWidgetHidden_Click()
   On Error GoTo chkWidgetHidden_Click_Error
    ...
    sPutINISetting "Software\PzRAMGauge", "widgetHidden", PzGWidgetHidden, PzGSettingsFile
...
'    End If
    ...
    If fFExists(PzGSettingsFile) Then
        sPutINISetting "Software\PzRAMGauge", "enableTooltips", PzGEnableTooltips, PzGSettingsFile
        sPutINISetting "Software\PzRAMGauge", "enablePrefsTooltips", PzGEnablePrefsTooltips, PzGSettingsFile
        sPutINISetting "Software\PzRAMGauge", "enableBalloonTooltips", PzGEnableBalloonTooltips, PzGSettingsFile
        sPutINISetting "Software\PzRAMGauge", "showTaskbar", PzGShowTaskbar, PzGSettingsFile
        sPutINISetting "Software\PzRAMGauge", "dpiAwareness", PzGDpiAwareness, PzGSettingsFile
        
        
        sPutINISetting "Software\PzRAMGauge", "gaugeSize", PzGGaugeSize, PzGSettingsFile
        ...
        'sPutINISetting "Software\PzRAMGauge", "clockFaceSwitchPref", PzGClockFaceSwitchPref, PzGSettingsFile
'        sPutINISetting "Software\PzRAMGauge", "mainGaugeTimeZone", PzGMainGaugeTimeZone, PzGSettingsFile
'        sPutINISetting "Software\PzRAMGauge", "mainDaylightSaving", PzGMainDaylightSaving, PzGSettingsFile
        'sPutINISetting "Software\PzRAMGauge", "secondaryGaugeTimeZone", PzGSecondaryGaugeTimeZone, PzGSettingsFile
        'sPutINISetting "Software\PzRAMGauge", "secondaryDaylightSaving", PzGSecondaryDaylightSaving, PzGSettingsFile
        
        sPutINISetting "Software\PzRAMGauge", "aspectHidden", PzGAspectHidden, PzGSettingsFile
        sPutINISetting "Software\PzRAMGauge", "widgetPosition", PzGWidgetPosition, PzGSettingsFile
        sPutINISetting "Software\PzRAMGauge", "widgetLandscape", PzGWidgetLandscape, PzGSettingsFile
        sPutINISetting "Software\PzRAMGauge", "widgetPortrait", PzGWidgetPortrait, PzGSettingsFile

        sPutINISetting "Software\PzRAMGauge", "prefsFont", PzGPrefsFont, PzGSettingsFile
        sPutINISetting "Software\PzRAMGauge", "clockFont", PzGClockFont, PzGSettingsFile
        
        sPutINISetting "Software\PzRAMGauge", "prefsFontSizeHighDPI", PzGPrefsFontSizeHighDPI, PzGSettingsFile
        sPutINISetting "Software\PzRAMGauge", "prefsFontSizeLowDPI", PzGPrefsFontSizeLowDPI, PzGSettingsFile
        sPutINISetting "Software\PzRAMGauge", "prefsFontItalics", PzGPrefsFontItalics, PzGSettingsFile
        sPutINISetting "Software\PzRAMGauge", "prefsFontColour", PzGPrefsFontColour, PzGSettingsFile

        'save the values from the Windows Config Items
        sPutINISetting "Software\PzRAMGauge", "windowLevel", PzGWindowLevel, PzGSettingsFile
        sPutINISetting "Software\PzRAMGauge", "preventDragging", PzGPreventDragging, PzGSettingsFile
        
        sPutINISetting "Software\PzRAMGauge", "opacity", PzGOpacity, PzGSettingsFile
        sPutINISetting "Software\PzRAMGauge", "widgetHidden", PzGWidgetHidden, PzGSettingsFile
        sPutINISetting "Software\PzRAMGauge", "hidingTime", PzGHidingTime, PzGSettingsFile
        sPutINISetting "Software\PzRAMGauge", "ignoreMouse", PzGIgnoreMouse, PzGSettingsFile
        
        
        sPutINISetting "Software\PzRAMGauge", "startup", PzGStartup, PzGSettingsFile

        sPutINISetting "Software\PzRAMGauge", "enableSounds", PzGEnableSounds, PzGSettingsFile
        sPutINISetting "Software\PzRAMGauge", "lastSelectedTab", PzGLastSelectedTab, PzGSettingsFile
        
        sPutINISetting "Software\PzRAMGauge", "debug", PzGDebug, PzGSettingsFile
        sPutINISetting "Software\PzRAMGauge", "dblClickCommand", PzGDblClickCommand, PzGSettingsFile
        sPutINISetting "Software\PzRAMGauge", "openFile", PzGOpenFile, PzGSettingsFile
        sPutINISetting "Software\PzRAMGauge", "defaultEditor", PzGDefaultEditor, PzGSettingsFile
        
        sPutINISetting "Software\PzRAMGauge", "clockHighDpiXPos", PzGClockHighDpiXPos, PzGSettingsFile
        sPutINISetting "Software\PzRAMGauge", "clockHighDpiYPos", PzGClockHighDpiYPos, PzGSettingsFile
        
        sPutINISetting "Software\PzRAMGauge", "clockLowDpiXPos", PzGClockLowDpiXPos, PzGSettingsFile
        sPutINISetting "Software\PzRAMGauge", "clockLowDpiYPos", PzGClockLowDpiYPos, PzGSettingsFile
...
'    panzerPrefs.sliAnimationInterval.BackColor = RGB(redC, greenC, blueC)
    ...
    sPutINISetting "Software\PzRAMGauge", "skinTheme", PzGSkinTheme, PzGSettingsFile
