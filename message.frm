...
Private Sub Form_Activate()
   ...
   On Error GoTo Form_Activate_Error
    ...
    gblMessageAHeightTwips = fGetINISetting("Software\PzRAMGauge", "messageAHeightTwips", gblSettingsFile)
    gblMessageAWidthTwips = fGetINISetting("Software\PzRAMGauge", "messageAWidthTwips ", gblSettingsFile)
...
Private Sub Form_Resize()
    ...
    sPutINISetting "Software\PzRAMGauge", "messageAHeightTwips", gblMessageAHeightTwips, gblSettingsFile
    sPutINISetting "Software\PzRAMGauge", "messageAWidthTwips", gblMessageAWidthTwips, gblSettingsFile
...
Public Property Let propTitle(ByVal newValue As String)
   On Error GoTo propTitle_Error
    ...
    If mPropTitle = "" Then
        Me.Caption = "Panzer-RAM-Gauge-" & gblCodingEnvironment & " Message."
    Else
