...
'        gblMainDaylightSaving = fGetINISetting(location, "mainDaylightSaving", gblSettingsFile)
        ...
        ' other
        gblClockHighDpiXPos = fGetINISetting("Software\PzRAMGauge", "clockHighDpiXPos", gblSettingsFile)
        gblClockHighDpiYPos = fGetINISetting("Software\PzRAMGauge", "clockHighDpiYPos", gblSettingsFile)
        
        gblClockLowDpiXPos = fGetINISetting("Software\PzRAMGauge", "clockLowDpiXPos", gblSettingsFile)
        gblClockLowDpiYPos = fGetINISetting("Software\PzRAMGauge", "clockLowDpiYPos", gblSettingsFile)
