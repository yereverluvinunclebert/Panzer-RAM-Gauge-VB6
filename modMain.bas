...
Public Sub mainRoutine(ByVal restart As Boolean)
    ...
    Call readSettingsFile("Software\PzRAMGauge", PzGSettingsFile)
...
Private Sub checkFirstTime()
   ...
   On Error GoTo checkFirstTime_Error
    ...
    If PzGFirstTimeRun = "true" Then
        ...
        sPutINISetting "Software\PzRAMGauge", "firstTimeRun", PzGFirstTimeRun, PzGSettingsFile
    End If
...
'        PzGMainDaylightSaving = fGetINISetting(location, "mainDaylightSaving", PzGSettingsFile)
        ...
        ' other
        PzGClockHighDpiXPos = fGetINISetting("Software\PzRAMGauge", "clockHighDpiXPos", PzGSettingsFile)
        PzGClockHighDpiYPos = fGetINISetting("Software\PzRAMGauge", "clockHighDpiYPos", PzGSettingsFile)
        
        PzGClockLowDpiXPos = fGetINISetting("Software\PzRAMGauge", "clockLowDpiXPos", PzGSettingsFile)
        PzGClockLowDpiYPos = fGetINISetting("Software\PzRAMGauge", "clockLowDpiYPos", PzGSettingsFile)
...
Private Sub getToolSettingsFile()
    ...
    PzGSettingsDir = fSpecialFolder(feUserAppData) & "\PzRAMGauge" ' just for this user alone
...
Private Sub handleUnhideMode(ByVal thisUnhideMode As String)
    ...
    If thisUnhideMode = "unhide" Then     'parse the command line
        PzGUnhide = "true"
        sPutINISetting "Software\PzRAMGauge", "unhide", PzGUnhide, PzGSettingsFile
